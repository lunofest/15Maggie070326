const CACHE_NAME = 'cache-v45'; // Use a static or manually managed version
const RESOURCES_TO_PRECACHE = [
    'estilos/normalize.css?v45',
    'estilos/styles.css?v45',
    'estilos/mediaQueries.css?v45',
    'javascript/script.js?v45',
